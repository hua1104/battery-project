...
app = Flask(__name__)
app.secret_key = cfg_get("APP_SECRET_KEY", "app_secret_key", "change-me-in-production")
...
DB_CONFIG = {
    ...
    "password": cfg_get("DB_PASSWORD", "db_password", "your_db_password"),
...
def upgrade_db_structure():
    ...
    try:
        ...
        try:
            default_pass = cfg_get("INITIAL_ADMIN_PASSWORD", "initial_admin_password", "change_this_admin_password")
            cursor.execute("INSERT IGNORE INTO users (username, password, role) VALUES ('admin', %s, 'admin')", (generate_password_hash(default_pass),))
